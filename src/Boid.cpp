...
{
    Boid::avoidElement(boid, glm::vec3(0.f, 0.f, 0.f), 40.f, turnfactor);
    Boid::avoidElement(boid, glm::vec3(60.f, 50.f, 35.f), 40.f, turnfactor);
    Boid::avoidElement(boid, glm::vec3(-40.f, 30.f, -80.f), 40.f, turnfactor);
}
